...
<br><br><br><br><br>
  ...
  <div class="card" style="width: 16rem;position: relative; top: -150px; left: 25px" >
  <img src="retrogriv.jpg" class="card-img-top" alt="..." width="95" height="150"  >
  <a href="montar_evidencias.php"><div class="card-body" style="position: relative; top: 20px">
   <font color="black"> <h3><?php echo $codigo_curso ?></h3>
    <p class="card-text" style="background-color: white;"><?php echo $row2['nombre'] ?></p></font></a>
  </div>
</div><br><br><br>
